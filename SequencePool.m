...
switch varargin{1}
    ...
    case 'DEER_XY8N'
        DEER_XY8N();
    case 'OffRes_Pulse_Debug'
        OffRes_Pulse_Debug()
    case 'OffRes_Pulse_Debug_2'
        OffRes_Pulse_Debug_2()
    ...
    case 'Pulse_Cali_N'
        Pulse_Cali_N()
    case 'Pulse_Cali_XY_N'
        Pulse_Cali_XY_N()
    case 'Pulse_Cali_N_XY_diff'
        Pulse_Cali_N_XY_diff()
    case 'Pulse_Cali_N_diff'
        Pulse_Cali_N_diff()
    case 'XY8N_Cali'
        XY8N_Cali()
    case 'Pi_Cali'
...
StrL{numel(StrL)+1}='Squeezing_XY8N';
...
StrL{numel(StrL)+1}= 'OffRes_Pulse_Debug';
StrL{numel(StrL)+1}= 'OffRes_Pulse_Debug_2';
...
gmSEQ.CHN(1).T = [gmSEQ.readout - gmSEQ.CtrGateDur - 1000, ...
    gmSEQ.readout + T_AfterLaser + gmSEQ.pi + PulseGap + gmSEQ.m + PulseGap + gmSEQ.pi + T_AfterPulse];
gmSEQ.CHN(1).DT = [gmSEQ.CtrGateDur, gmSEQ.CtrGateDur];

gmSEQ.CHN(numel(gmSEQ.CHN) + 1).PBN = PBDictionary('MWSwitch');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 3;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [gmSEQ.readout + T_AfterLaser - MWBuffer, gmSEQ.readout + T_AfterLaser + gmSEQ.pi + PulseGap - MWBuffer, ...
    gmSEQ.readout + T_AfterLaser + gmSEQ.pi + PulseGap + gmSEQ.m + PulseGap - MWBuffer];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [gmSEQ.pi + 2*MWBuffer, gmSEQ.m + 2*MWBuffer, gmSEQ.pi + 2*MWBuffer];
...
WaveForm_1 = [0, gmSEQ.pi, gSG.AWGFreq, 0, gSG.AWGAmp, 0, 0, 0; ...
    gmSEQ.pi + PulseGap, gmSEQ.pi + PulseGap + gmSEQ.m, gmSEQ.SAmp1, 0, gmSEQ.SAmp2, gmSEQ.SAmp1_M, 0, gmSEQ.SAmp2_M; ...
    gmSEQ.pi + PulseGap + gmSEQ.m + PulseGap, gmSEQ.pi + PulseGap + gmSEQ.m + PulseGap + gmSEQ.pi, gSG.AWGFreq, pi, gSG.AWGAmp, 0, 0, 0;];
% WaveForm_1 = [0, gmSEQ.m, gSG.AWGFreq, 0, gSG.AWGAmp, 0, 0, 0];
WaveForm_2 = WaveForm_1 + repmat([0 0 0 pi/2 0 0 -pi/2 0], size(WaveForm_1, 1), 1);


WaveForm_Length = ceil((gmSEQ.pi + PulseGap + gmSEQ.m + PulseGap + gmSEQ.pi + 1000) / (16/gSG.AWGClockRate)) * (16/gSG.AWGClockRate);
WaveForm_PointNum = WaveForm_Length*gSG.AWGClockRate;
...
% TODO: add the definition for the pi and gmSEQ.halfpi pulse AWG amp
gSG.piAWGAmp = gSG.AWGAmp; % Just for temporary use
gSG.halfpiAWGAmp = gSG.AWGAmp; % Just for temporary use
gSG2.piAWGAmp = gSG2.AWGAmp; % Just for temporary use
gSG2.halfpiAWGAmp = gSG2.AWGAmp; % Just for temporary use
...
Sig_D_start = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi+Detect_Window+Wait_p;

gmSEQ.CHN(1).PBN=PBDictionary('ctr0');
gmSEQ.CHN(1).NRise=4;
gmSEQ.CHN(1).T=[Wait_p+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ...
    Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi, ...
    Sig_D_start+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ... 
    Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi];
if strcmp(gmSEQ.meas,'SPCM')
    gmSEQ.CHN(1).DT=[gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur];
elseif strcmp(gmSEQ.meas,'APD')
    gmSEQ.CHN(1).DT=[1000 1000 1000 1000];
...
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AOM');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=4;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [Wait_p, Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi, ...
    Sig_D_start, Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [gmSEQ.readout Detect_Window gmSEQ.readout Detect_Window];

% Probe group
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AWGTrig2');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse, ...
    Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.DEERpi+200, 2);

% Bath/squeezed group
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AWGTrig');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser, Sig_D_start+gmSEQ.readout+AfterLaser];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.halfpi+Cycle*gmSEQ.m+200, 2);

bufferTime = 10;
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('MWSwitch2');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse-bufferTime, ...
    Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*gmSEQ.m+AfterPulse-bufferTime];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.DEERpi+2*bufferTime, 2);


gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('MWSwitch');
if gmSEQ.interval < 80 || gmSEQ.m == 0
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser-bufferTime, ...
        Sig_D_start+gmSEQ.readout+AfterLaser-bufferTime];
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT = repelem(gmSEQ.halfpi+Cycle*gmSEQ.m+2*bufferTime, 2);
else
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2*(8*gmSEQ.m + 1);
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = zeros(1, 2*(8*gmSEQ.m + 1));
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1) = Wait_p+gmSEQ.readout+AfterLaser-bufferTime;
    for i = 1:gmSEQ.m
        for j = 1:8
            gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+(i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-bufferTime;
        end
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*gmSEQ.m+1) = Sig_D_start+gmSEQ.readout+AfterLaser-bufferTime;
    for i = 1:gmSEQ.m
        for j = 1:8
            gmSEQ.CHN(numel(gmSEQ.CHN)).T(2+8*gmSEQ.m+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-bufferTime;
        end
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.halfpi+2*bufferTime, repelem(gmSEQ.pi+2*bufferTime, 8*gmSEQ.m), gmSEQ.halfpi+2*bufferTime, repelem(gmSEQ.pi+2*bufferTime, 8*gmSEQ.m)];
end
...
WaveForm_1I = zeros(1 + 8*gmSEQ.m, 5);
WaveForm_1I(1, :) = [0 gmSEQ.halfpi gSG.AWGFreq 0 gSG.halfpiAWGAmp];
for i = 1:gmSEQ.m
...
WaveForm_1Q = WaveForm_1I - repmat([0 0 0 pi/2 0], size(WaveForm_1I, 1), 1);
WaveForm_1Length = ceil((gmSEQ.halfpi+gmSEQ.m*Cycle+1000) / (16 / gSG.AWGClockRate)) ...
    *(16 / gSG.AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length * gSG.AWGClockRate;

WaveForm_2I = [0 gmSEQ.DEERpi gSG2.AWGFreq 0 0];
WaveForm_2Q = WaveForm_2I - repmat([0 0 0 pi/2 0], size(WaveForm_2I, 1), 1);
WaveForm_2Length = ceil((gmSEQ.DEERpi+1000) / (16 / gSG2.P1AWGClockRate)) ...
    *(16 / gSG2.P1AWGClockRate);
WaveForm_2PointNum = WaveForm_2Length * gSG2.P1AWGClockRate;

WaveForm_3I = [0 gmSEQ.DEERpi gSG2.AWGFreq 0 gSG2.piAWGAmp];
WaveForm_3Q = WaveForm_3I - repmat([0 0 0 pi/2 0], size(WaveForm_3I, 1), 1);
WaveForm_3Length = ceil((gmSEQ.DEERpi+1000) / (16 / gSG2.P1AWGClockRate)) ...
    *(16 / gSG2.P1AWGClockRate);
WaveForm_3PointNum = WaveForm_3Length * gSG2.P1AWGClockRate;
...
function OffRes_Pulse_Debug_old
...
gSG2.piAWGAmp = gSG2.AWGAmp; % Just for temporary use
gSG2.halfpiAWGAmp = gSG2.AWGAmp; % Just for temporary use
gSG3.piAWGAmp = gSG3.AWGAmp; % Just for temporary use
gSG3.halfpiAWGAmp = gSG3.AWGAmp; % Just for temporary use
...
WaveForm_1I = zeros(1 + 8*gmSEQ.m, 5);
WaveForm_1I(1, :) = [0 gmSEQ.halfpi gSG3.AWGFreq 0 gSG3.halfpiAWGAmp];
for i = 1:gmSEQ.m
    WaveForm_1I(1 + (i-1)*8 + 1, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; % pi_x
    WaveForm_1I(1 + (i-1)*8 + 2, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi gSG3.AWGFreq pi/2 gSG3.piAWGAmp]; % pi_y
    WaveForm_1I(1 + (i-1)*8 + 3, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+2/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+2/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; % pi_x
    WaveForm_1I(1 + (i-1)*8 + 4, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+3/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+3/8)*Cycle+gmSEQ.pi gSG3.AWGFreq pi/2 gSG3.piAWGAmp]; % pi_y
    WaveForm_1I(1 + (i-1)*8 + 5, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+4/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+4/8)*Cycle+gmSEQ.pi gSG3.AWGFreq pi/2 gSG3.piAWGAmp]; % pi_y
    WaveForm_1I(1 + (i-1)*8 + 6, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; % pi_x
    WaveForm_1I(1 + (i-1)*8 + 7, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi gSG3.AWGFreq pi/2 gSG3.piAWGAmp]; % pi_y
    WaveForm_1I(1 + (i-1)*8 + 8, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; % pi_x
end
WaveForm_1Q = WaveForm_1I - repmat([0 0 0 pi/2 0], size(WaveForm_1I, 1), 1);
WaveForm_1Length = ceil((gmSEQ.halfpi+gmSEQ.m*Cycle+1000) / (16 / gSG3.AWGClockRate)) ...
    *(16 / gSG3.AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length * gSG3.AWGClockRate;
...
chaseFunctionPool('createWaveform', WaveForm_1I, gSG3.AWGClockRate, WaveForm_1Length, 'DEER_XY8N_I_seg1.txt'); pause(0.5);
chaseFunctionPool('createWaveform', WaveForm_1Q, gSG3.AWGClockRate, WaveForm_1Length, 'DEER_XY8N_Q_seg1.txt'); pause(0.5);
chaseFunctionPool('createWaveform', WaveForm_2I, gSG2.P1AWGClockRate, WaveForm_2Length, 'DEER_XY8N_I_seg2.txt'); pause(0.5);
chaseFunctionPool('createWaveform', WaveForm_2Q, gSG2.P1AWGClockRate, WaveForm_2Length, 'DEER_XY8N_Q_seg2.txt'); pause(0.5);
chaseFunctionPool('createWaveform', WaveForm_3I, gSG2.P1AWGClockRate, WaveForm_3Length, 'DEER_XY8N_I_seg3.txt'); pause(0.5);
chaseFunctionPool('createWaveform', WaveForm_3Q, gSG2.P1AWGClockRate, WaveForm_3Length, 'DEER_XY8N_Q_seg3.txt'); pause(0.5);
...
chaseFunctionPool('createSegStruct', 'DEER_XY8N_SegStruct_I.txt', ...
    'DEER_XY8N_I_seg1.txt', WaveForm_1PointNum, 1, 1, ...
    'DEER_XY8N_I_seg1.txt', WaveForm_2PointNum, 1, 1);
pause(0.5);
chaseFunctionPool('createSegStruct', 'DEER_XY8N_SegStruct_Q.txt', ...
    'DEER_XY8N_Q_seg1.txt', WaveForm_1PointNum, 1, 1, ...
    'DEER_XY8N_Q_seg1.txt', WaveForm_2PointNum, 1, 1);
pause(0.5);
chaseFunctionPool('createSegStruct', 'DEER_XY8N_P1_SegStruct_I.txt', ...
    'DEER_XY8N_I_seg2.txt', WaveForm_3PointNum, 1, 1, ...
    'DEER_XY8N_I_seg3.txt', WaveForm_3PointNum, 1, 1);
pause(0.5);
chaseFunctionPool('createSegStruct', 'DEER_XY8N_P1_SegStruct_Q.txt', ...
    'DEER_XY8N_Q_seg2.txt', WaveForm_3PointNum, 1, 1, ...
    'DEER_XY8N_Q_seg3.txt', WaveForm_3PointNum, 1, 1);
pause(0.5);
...
gmSEQ.DEERhalfpi = gmSEQ.DEERpi/2;
pulseGap = 40;
Cycle = (gmSEQ.interval + 2*gmSEQ.pi + pulseGap)*8;
Sig_D_start = Wait_p+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi+Detect_Window+Wait_p;

gmSEQ.CHN(1).PBN=PBDictionary('ctr0');
gmSEQ.CHN(1).NRise=4;
gmSEQ.CHN(1).T=[Wait_p+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ...
    Wait_p+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi, ...
    Sig_D_start+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ... 
    Sig_D_start+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi];
if strcmp(gmSEQ.meas,'SPCM')
    gmSEQ.CHN(1).DT=[gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur];
elseif strcmp(gmSEQ.meas,'APD')
    gmSEQ.CHN(1).DT=[1000 1000 1000 1000];
...
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AOM');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=4;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [Wait_p, Wait_p+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi, ...
    Sig_D_start, Sig_D_start+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse+gmSEQ.DEERpi+AfterPi];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [gmSEQ.readout Detect_Window gmSEQ.readout Detect_Window];

% Probe group
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AWGTrig2');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse, ...
    Sig_D_start+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.DEERpi+200, 2);
...
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('MWSwitch2');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse-bufferTime, ...
    Sig_D_start+gmSEQ.readout+AfterLaser+Cycle*gmSEQ.m+AfterPulse-bufferTime];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.DEERpi+2*bufferTime, 2);
...
if gmSEQ.interval < 80 || gmSEQ.m == 0
    ...
    gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser-bufferTime, ...
        Sig_D_start+gmSEQ.readout+AfterLaser-bufferTime];
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT = repelem(Cycle*gmSEQ.m+2*bufferTime, 2);
else
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=16*gmSEQ.m;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = zeros(1, 16*gmSEQ.m);
    for i = 1:gmSEQ.m
        for j = 1:8
            gmSEQ.CHN(numel(gmSEQ.CHN)).T((i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-bufferTime;
        end
    end
    for i = 1:gmSEQ.m
        for j = 1:8
            gmSEQ.CHN(numel(gmSEQ.CHN)).T(8*gmSEQ.m+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-bufferTime;
        end
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(2*gmSEQ.pi+pulseGap+2*bufferTime, 16*gmSEQ.m);
end
...
WaveForm_1I = zeros(16*gmSEQ.m+1, 5);
WaveForm_1I(1, :) = [0 gmSEQ.interval/2 gSG3.AWGFreq 0 0];
% for i = 1:gmSEQ.m
%     WaveForm_1I(1 + (i-1)*16 + 1, :) = [gmSEQ.interval/2+(i-1+0/8)*Cycle gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp];
%     WaveForm_1I(1 + (i-1)*16 + 2, :) = [gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+0/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq 0 gSG3.piAWGAmp];
%     WaveForm_1I(1 + (i-1)*16 + 3, :) = [gmSEQ.interval/2+(i-1+1/8)*Cycle gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp];
%     WaveForm_1I(1 + (i-1)*16 + 4, :) = [gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+1/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 5, :) = [gmSEQ.interval/2+(i-1+2/8)*Cycle gmSEQ.interval/2+(i-1+2/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 6, :) = [gmSEQ.interval/2+(i-1+2/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+2/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 7, :) = [gmSEQ.interval/2+(i-1+3/8)*Cycle gmSEQ.interval/2+(i-1+3/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 8, :) = [gmSEQ.interval/2+(i-1+3/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+3/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 9, :) = [gmSEQ.interval/2+(i-1+4/8)*Cycle gmSEQ.interval/2+(i-1+4/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp];
%     WaveForm_1I(1 + (i-1)*16 + 10, :) = [gmSEQ.interval/2+(i-1+4/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+4/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq 0 gSG3.piAWGAmp];
%     WaveForm_1I(1 + (i-1)*16 + 11, :) = [gmSEQ.interval/2+(i-1+5/8)*Cycle gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 12, :) = [gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+5/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 13, :) = [gmSEQ.interval/2+(i-1+6/8)*Cycle gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 14, :) = [gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+6/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
%     WaveForm_1I(1 + (i-1)*16 + 15, :) = [gmSEQ.interval/2+(i-1+7/8)*Cycle gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp];
%     WaveForm_1I(1 + (i-1)*16 + 16, :) = [gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+7/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq 0 gSG3.piAWGAmp];
% end
for i = 1:gmSEQ.m
    WaveForm_1I(1 + (i-1)*16 + 1, :) = [gmSEQ.interval/2+(i-1+0/8)*Cycle gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp];
    WaveForm_1I(1 + (i-1)*16 + 2, :) = [gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+0/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq pi gSG3.piAWGAmp];
    WaveForm_1I(1 + (i-1)*16 + 3, :) = [gmSEQ.interval/2+(i-1+1/8)*Cycle gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp];
    WaveForm_1I(1 + (i-1)*16 + 4, :) = [gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+1/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq pi gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 5, :) = [gmSEQ.interval/2+(i-1+2/8)*Cycle gmSEQ.interval/2+(i-1+2/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 6, :) = [gmSEQ.interval/2+(i-1+2/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+2/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq pi gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 7, :) = [gmSEQ.interval/2+(i-1+3/8)*Cycle gmSEQ.interval/2+(i-1+3/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 8, :) = [gmSEQ.interval/2+(i-1+3/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+3/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq pi gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 9, :) = [gmSEQ.interval/2+(i-1+4/8)*Cycle gmSEQ.interval/2+(i-1+4/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp];
    WaveForm_1I(1 + (i-1)*16 + 10, :) = [gmSEQ.interval/2+(i-1+4/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+4/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq pi gSG3.piAWGAmp];
    WaveForm_1I(1 + (i-1)*16 + 11, :) = [gmSEQ.interval/2+(i-1+5/8)*Cycle gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 12, :) = [gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+5/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq pi gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 13, :) = [gmSEQ.interval/2+(i-1+6/8)*Cycle gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 14, :) = [gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+6/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq pi gSG3.piAWGAmp]; 
    WaveForm_1I(1 + (i-1)*16 + 15, :) = [gmSEQ.interval/2+(i-1+7/8)*Cycle gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi gSG3.AWGFreq 0 gSG3.piAWGAmp];
    WaveForm_1I(1 + (i-1)*16 + 16, :) = [gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi+pulseGap gmSEQ.interval/2+(i-1+7/8)*Cycle+2*gmSEQ.pi+pulseGap gSG3.AWGFreq pi gSG3.piAWGAmp];
end
WaveForm_1Q = WaveForm_1I - repmat([0 0 0 pi/2 0], size(WaveForm_1I, 1), 1);
WaveForm_1Length = ceil((gmSEQ.m*Cycle+1000) / (16 / gSG3.AWGClockRate)) ...
    *(16 / gSG3.AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length * gSG3.AWGClockRate;
...
% Pi pulse duration definition
SquPi = gmSEQ.pi; % Pulse duration for the squeezing pulse 
DetPi = gmSEQ.DEERpi; % Pulse duraation for the detection pulse  
DoublePi = gmSEQ.LockN0; % Pulse duration for the double quantum basis 0<->1 driving 

PulseGap = 2;

% Squeezing parameter definitions
SquInterval = gmSEQ.SLockT1; % XY8 interval to generate the squeezing
SquN = round(gmSEQ.SLockT2); % XY8 number
SquTime = SquN * (SquInterval + SquPi)*8;
SquAmp = gmSEQ.SAmp1;

% Rotation parameter defintions
RotTime = DetPi + PulseGap + DoublePi + PulseGap;

RotAngleList = [0, 1/4, 1/2, 3/4];
gmSEQ.Ntomo = 4;
gmSEQ.bTomo = gmSEQ.Alternate;
if gmSEQ.bTomo
    RotAngle = RotAngleList(gmSEQ.CoolSwitch+1)*DetPi;
    disp("Loading gmSEQ.m = " + num2str(gmSEQ.m) + ", rotation time is " + num2str(RotAngle) + " ns.")
else
    RotAngle = gmSEQ.DEERt;
end

% Detection parameter definitons
DetInterval = gmSEQ.SLockT1_M;
DetN = round(gmSEQ.m);
DetUnit = DetInterval + 2*DoublePi + DetPi + 2*PulseGap;
DetTime = DetPi/2 + DetN * DetUnit*8 + DetPi/2;
...
Sig_D_start = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetTime+AfterPi+Detect_Window+Wait_p;

gmSEQ.CHN(1).PBN=PBDictionary('ctr0');
gmSEQ.CHN(1).NRise=4;
gmSEQ.CHN(1).T=[Wait_p+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ...
    Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetTime+AfterPi, ...
    Sig_D_start+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ... 
    Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetTime+AfterPi];
if strcmp(gmSEQ.meas,'SPCM')
    gmSEQ.CHN(1).DT=[gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur];
elseif strcmp(gmSEQ.meas,'APD')
    gmSEQ.CHN(1).DT=[1000 1000 1000 1000];
...
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AOM');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=4;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [Wait_p, Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetTime+AfterPi, ...
    Sig_D_start, Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetTime+AfterPi];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [gmSEQ.readout Detect_Window gmSEQ.readout Detect_Window];

% MW for probe spin
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AWGTrig2');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime, Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(DetTime+200, 2);
...
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser, Sig_D_start+gmSEQ.readout+AfterLaser];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(SquPi/2+SquTime+RotTime+DetTime+200, 2);
...
if DetN == 0
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = [Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime-MWBuffer-2, Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime-MWBuffer-2];
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT = repelem(DetTime+2*MWBuffer+2, 2);
else
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2*(8*DetN + 2);
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = zeros(1, gmSEQ.CHN(numel(gmSEQ.CHN)).NRise);
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1) = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime-MWBuffer-2;
    for i = 1:DetN
        for j = 1:8
            gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+(i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+j-1)*DetUnit-MWBuffer;
        end
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*DetN+1) = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetPi/2+DetN*DetUnit*8-MWBuffer;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*DetN+2) = Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime-MWBuffer-2;
    for i = 1:DetN
        for j = 1:8
            gmSEQ.CHN(numel(gmSEQ.CHN)).T(3+8*DetN+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+j-1)*DetUnit-MWBuffer;
        end
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(3+16*DetN+1) = Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetPi/2+DetN*DetUnit*8-MWBuffer;
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[DetPi/2+2*MWBuffer+2, repelem(DetPi+2*DoublePi+2*PulseGap+2*MWBuffer, 8*DetN), DetPi/2+2*MWBuffer, ... 
        DetPi/2+2*MWBuffer+2, repelem(DetPi+2*DoublePi+2*PulseGap+2*MWBuffer, 8*DetN), DetPi/2+2*MWBuffer];    
end
...
for i = 1:SquN
    for j = 1:8
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+(i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquInterval/2+((i-1)*8+j-1)*(SquInterval+gmSEQ.pi)-MWBuffer;
    end
end
gmSEQ.CHN(numel(gmSEQ.CHN)).T(2+SquN*8) = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime-MWBuffer;
for i = 1:DetN
    for j = 1:8
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(2+SquN*8+(i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+j-1)*DetUnit-MWBuffer;
    end
end
gmSEQ.CHN(numel(gmSEQ.CHN)).T(8*SquN+8*DetN+3) = Sig_D_start+gmSEQ.readout+AfterLaser-MWBuffer;
for i = 1:SquN
    for j = 1:8
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(8*SquN+8*DetN+3+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquInterval/2+((i-1)*8+j-1)*(SquInterval+gmSEQ.pi)-MWBuffer;
    end
end
gmSEQ.CHN(numel(gmSEQ.CHN)).T(4+16*SquN+8*DetN) = Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime-MWBuffer;
for i = 1:DetN
    for j = 1:8
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(4+16*SquN+8*DetN+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+j-1)*DetUnit-MWBuffer;
    end
end
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[SquPi/2+2*MWBuffer, repelem(SquPi+2*MWBuffer, 8*SquN), RotTime+2*MWBuffer,  repelem(DetPi+2*DoublePi+2*PulseGap+2*MWBuffer, 8*DetN), ... 
    SquPi/2+2*MWBuffer, repelem(SquPi+2*MWBuffer, 8*SquN), RotTime+2*MWBuffer,  repelem(DetPi+2*DoublePi+2*PulseGap+2*MWBuffer, 8*DetN)];


gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('MWSwitch3');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2*(8*DetN + 1);
gmSEQ.CHN(numel(gmSEQ.CHN)).T = zeros(1, gmSEQ.CHN(numel(gmSEQ.CHN)).NRise);
gmSEQ.CHN(numel(gmSEQ.CHN)).T(1) = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+DetPi+PulseGap-MWBuffer;
for i = 1:DetN
    for j = 1:8
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+(i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+j-1)*DetUnit-MWBuffer;
    end
end
gmSEQ.CHN(numel(gmSEQ.CHN)).T(2+8*DetN) = Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+DetPi+PulseGap-MWBuffer;
for i = 1:DetN
    for j = 1:8
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(2+8*DetN+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+SquPi/2+SquTime+RotTime+gmSEQ.DEERhalfpi+DetInterval/2+(8*(i-1)+j-1)*DetUnit-MWBuffer;
    end
end
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[DoublePi+2*MWBuffer+6,  repelem(DetPi+2*DoublePi+2*PulseGap+2*MWBuffer, 8*DetN), ... 
    DoublePi+2*MWBuffer+6,  repelem(DetPi+2*DoublePi+2*PulseGap+2*MWBuffer, 8*DetN)];
...
% SqueezeACFreq = 0;
ProbeACFreq = 0.00126;
SqueezeACFreq = -0.0008; 

if gmSEQ.m == 0 
    WaveForm_1I = [0 DetPi gSG2.AWGFreq 0 0];
else
    WaveForm_1I = zeros(2 + 8*DetN, 5);
    WaveForm_1I(1, :) = [0 DetPi/2 gSG2.AWGFreq 0 gSG2.AWGAmp];
    for i = 1:DetN
        WaveForm_1I(1 + (i-1)*8 + 1, :) = [DetPi/2+DetInterval/2+(8*(i-1)+0)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+0)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq 0 gSG2.AWGAmp]; % pi_x
        WaveForm_1I(1 + (i-1)*8 + 2, :) = [DetPi/2+DetInterval/2+(8*(i-1)+1)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+1)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq pi/2 gSG2.AWGAmp]; % pi_y
        WaveForm_1I(1 + (i-1)*8 + 3, :) = [DetPi/2+DetInterval/2+(8*(i-1)+2)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+2)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq 0 gSG2.AWGAmp]; % pi_x
        WaveForm_1I(1 + (i-1)*8 + 4, :) = [DetPi/2+DetInterval/2+(8*(i-1)+3)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+3)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq pi/2 gSG2.AWGAmp]; % pi_y
        WaveForm_1I(1 + (i-1)*8 + 5, :) = [DetPi/2+DetInterval/2+(8*(i-1)+4)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+4)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq pi/2 gSG2.AWGAmp]; % pi_y
        WaveForm_1I(1 + (i-1)*8 + 6, :) = [DetPi/2+DetInterval/2+(8*(i-1)+5)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+5)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq 0 gSG2.AWGAmp]; % pi_x
        WaveForm_1I(1 + (i-1)*8 + 7, :) = [DetPi/2+DetInterval/2+(8*(i-1)+6)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+6)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq pi/2 gSG2.AWGAmp]; % pi_y
        WaveForm_1I(1 + (i-1)*8 + 8, :) = [DetPi/2+DetInterval/2+(8*(i-1)+7)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+7)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq 0 gSG2.AWGAmp]; % pi_x
    end
    WaveForm_1I(2 + 8*DetN, :) = [DetPi/2+8*DetN*DetUnit DetPi/2+8*DetN*DetUnit+DetPi/2 gSG2.AWGFreq pi gSG2.AWGAmp];
    % WaveForm_1I(2 + 8*DetN, :) = [DetPi/2+8*DetN*DetUnit DetPi/2+8*DetN*DetUnit+DetPi/2 gSG2.AWGFreq 2*pi*ProbeACFreq*(DetPi/2+8*DetN*DetUnit)+pi gSG2.AWGAmp];
end
WaveForm_1I(2:1+8*DetN, 4) = WaveForm_1I(2:1+8*DetN, 4) - 2*pi*ProbeACFreq*WaveForm_1I(2:1+8*DetN, 1);
WaveForm_1Q = WaveForm_1I - repmat([0 0 0 pi/2 0], size(WaveForm_1I, 1), 1);
WaveForm_1Length = ceil((DetPi/2+8*DetN*DetUnit+DetPi/2+1000) / (16 / gSG2.P1AWGClockRate)) ...
    *(16 / gSG2.P1AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length * gSG2.P1AWGClockRate;

if gmSEQ.m == 0
    WaveForm_2I = [0 DetPi gSG2.AWGFreq 0 gSG2.AWGAmp];
    WaveForm_2Q = WaveForm_2I - repmat([0 0 0 pi/2 0], size(WaveForm_2I, 1), 1);
else
    WaveForm_2I = WaveForm_1I;
    WaveForm_2I(size(WaveForm_1I, 1), 4) = WaveForm_2I(size(WaveForm_1I, 1), 4) - pi; % Differential measurement
    WaveForm_2Q = WaveForm_1Q;
    WaveForm_2Q(size(WaveForm_1I, 1), 4) = WaveForm_2Q(size(WaveForm_1I, 1), 4) - pi; % Differential measurement
end
WaveForm_2Length = WaveForm_1Length;
WaveForm_2PointNum = WaveForm_2Length * gSG2.P1AWGClockRate;
...
% Squeezed spin
WaveForm_3I = zeros(2 + 8*SquN + 8*DetN, 5);
WaveForm_3I(1, :) = [0 SquPi/2 gSG.AWGFreq 0 SquAmp];
% WaveForm_3I(1, :) = [0 gmSEQ.halfpi gSG.AWGFreq 0 gSG.AWGAmp];
for i = 1:SquN
    WaveForm_3I(1 + (i-1)*8 + 1, :) = [SquPi/2+SquInterval/2+(8*(i-1)+0)*(SquInterval+SquPi) SquPi/2+SquInterval/2+(8*(i-1)+0)*(SquInterval+SquPi)+SquPi gSG.AWGFreq 0 SquAmp]; % pi_x
    WaveForm_3I(1 + (i-1)*8 + 2, :) = [SquPi/2+SquInterval/2+(8*(i-1)+1)*(SquInterval+SquPi) SquPi/2+SquInterval/2+(8*(i-1)+1)*(SquInterval+SquPi)+SquPi gSG.AWGFreq pi/2 SquAmp]; % pi_y
    WaveForm_3I(1 + (i-1)*8 + 3, :) = [SquPi/2+SquInterval/2+(8*(i-1)+2)*(SquInterval+SquPi) SquPi/2+SquInterval/2+(8*(i-1)+2)*(SquInterval+SquPi)+SquPi gSG.AWGFreq 0 SquAmp]; % pi_x
    WaveForm_3I(1 + (i-1)*8 + 4, :) = [SquPi/2+SquInterval/2+(8*(i-1)+3)*(SquInterval+SquPi) SquPi/2+SquInterval/2+(8*(i-1)+3)*(SquInterval+SquPi)+SquPi gSG.AWGFreq pi/2 SquAmp]; % pi_y
    WaveForm_3I(1 + (i-1)*8 + 5, :) = [SquPi/2+SquInterval/2+(8*(i-1)+4)*(SquInterval+SquPi) SquPi/2+SquInterval/2+(8*(i-1)+4)*(SquInterval+SquPi)+SquPi gSG.AWGFreq pi/2 SquAmp]; % pi_y
    WaveForm_3I(1 + (i-1)*8 + 6, :) = [SquPi/2+SquInterval/2+(8*(i-1)+5)*(SquInterval+SquPi) SquPi/2+SquInterval/2+(8*(i-1)+5)*(SquInterval+SquPi)+SquPi gSG.AWGFreq 0 SquAmp]; % pi_x
    WaveForm_3I(1 + (i-1)*8 + 7, :) = [SquPi/2+SquInterval/2+(8*(i-1)+6)*(SquInterval+SquPi) SquPi/2+SquInterval/2+(8*(i-1)+6)*(SquInterval+SquPi)+SquPi gSG.AWGFreq pi/2 SquAmp]; % pi_y
    WaveForm_3I(1 + (i-1)*8 + 8, :) = [SquPi/2+SquInterval/2+(8*(i-1)+7)*(SquInterval+SquPi) SquPi/2+SquInterval/2+(8*(i-1)+7)*(SquInterval+SquPi)+SquPi gSG.AWGFreq 0 SquAmp]; % pi_x
end
WaveForm_3I(2 + 8*SquN, :) = [SquPi/2+SquTime SquPi/2+SquTime+RotAngle gSG.AWGFreq pi/2 gSG.AWGAmp]; % theta pulse along y direction
for i = 1:DetN
    WaveForm_3I(2 + 8*SquN + (i-1)*8 + 1, :) = [SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+0)*DetUnit+DoublePi+PulseGap SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+0)*DetUnit+DoublePi+PulseGap+DetPi gSG.AWGFreq+SqueezeACFreq 0 gSG.AWGAmp]; % pi_x
    WaveForm_3I(2 + 8*SquN + (i-1)*8 + 2, :) = [SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+1)*DetUnit+DoublePi+PulseGap SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+1)*DetUnit+DoublePi+PulseGap+DetPi gSG.AWGFreq+SqueezeACFreq pi/2 gSG.AWGAmp]; % pi_y
    WaveForm_3I(2 + 8*SquN + (i-1)*8 + 3, :) = [SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+2)*DetUnit+DoublePi+PulseGap SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+2)*DetUnit+DoublePi+PulseGap+DetPi gSG.AWGFreq+SqueezeACFreq 0 gSG.AWGAmp]; % pi_x
    WaveForm_3I(2 + 8*SquN + (i-1)*8 + 4, :) = [SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+3)*DetUnit+DoublePi+PulseGap SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+3)*DetUnit+DoublePi+PulseGap+DetPi gSG.AWGFreq+SqueezeACFreq pi/2 gSG.AWGAmp]; % pi_y
    WaveForm_3I(2 + 8*SquN + (i-1)*8 + 5, :) = [SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+4)*DetUnit+DoublePi+PulseGap SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+4)*DetUnit+DoublePi+PulseGap+DetPi gSG.AWGFreq+SqueezeACFreq pi/2 gSG.AWGAmp]; % pi_y
    WaveForm_3I(2 + 8*SquN + (i-1)*8 + 6, :) = [SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+5)*DetUnit+DoublePi+PulseGap SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+5)*DetUnit+DoublePi+PulseGap+DetPi gSG.AWGFreq+SqueezeACFreq 0 gSG.AWGAmp]; % pi_x
    WaveForm_3I(2 + 8*SquN + (i-1)*8 + 7, :) = [SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+6)*DetUnit+DoublePi+PulseGap SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+6)*DetUnit+DoublePi+PulseGap+DetPi gSG.AWGFreq+SqueezeACFreq pi/2 gSG.AWGAmp]; % pi_y
    WaveForm_3I(2 + 8*SquN + (i-1)*8 + 8, :) = [SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+7)*DetUnit+DoublePi+PulseGap SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2+(8*(i-1)+7)*DetUnit+DoublePi+PulseGap+DetPi gSG.AWGFreq+SqueezeACFreq 0 gSG.AWGAmp]; % pi_x
end
WaveForm_3I(3+8*SquN:2+8*SquN+8*DetN, 4) = WaveForm_3I(3+8*SquN:2+8*SquN+8*DetN, 4) - 2*pi*SqueezeACFreq*WaveForm_3I(3+8*SquN:2+8*SquN+8*DetN, 1);

WaveForm_3Q = WaveForm_3I - repmat([0 0 0 pi/2 0], size(WaveForm_3I, 1), 1);
WaveForm_3Length = ceil((SquPi/2+SquTime+RotTime+DetPi/2+8*DetN*DetUnit+1000) / (16 / gSG.AWGClockRate)) ...
    *(16 / gSG.AWGClockRate);
WaveForm_3PointNum = WaveForm_3Length * gSG.AWGClockRate;

% Squeezed spin 2
WaveForm_4I = zeros(2 + 16*DetN, 5);
WaveForm_4I(1, :) = [0 SquPi/2+SquTime+DetPi+PulseGap gSG2.AWGFreq 0 0];
WaveForm_4I(2, :) = [SquPi/2+SquTime+DetPi+PulseGap SquPi/2+SquTime+DetPi+PulseGap+DoublePi gSG2.AWGFreq pi gSG3.AWGAmp];
timeOffset = SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2;
for i = 1:DetN
    WaveForm_4I(2 + (i-1)*16 + 1, :) = [timeOffset+(8*(i-1)+0)*DetUnit timeOffset+(8*(i-1)+0)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp];
    WaveForm_4I(2 + (i-1)*16 + 2, :) = [timeOffset+(8*(i-1)+0)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+0)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp]; 
    WaveForm_4I(2 + (i-1)*16 + 3, :) = [timeOffset+(8*(i-1)+1)*DetUnit timeOffset+(8*(i-1)+1)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp];
    WaveForm_4I(2 + (i-1)*16 + 4, :) = [timeOffset+(8*(i-1)+1)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+1)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp];
    WaveForm_4I(2 + (i-1)*16 + 5, :) = [timeOffset+(8*(i-1)+2)*DetUnit timeOffset+(8*(i-1)+2)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp];
    WaveForm_4I(2 + (i-1)*16 + 6, :) = [timeOffset+(8*(i-1)+2)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+2)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp];
    WaveForm_4I(2 + (i-1)*16 + 7, :) = [timeOffset+(8*(i-1)+3)*DetUnit timeOffset+(8*(i-1)+3)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp]; 
    WaveForm_4I(2 + (i-1)*16 + 8, :) = [timeOffset+(8*(i-1)+3)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+3)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp]; 
    WaveForm_4I(2 + (i-1)*16 + 9, :) = [timeOffset+(8*(i-1)+4)*DetUnit timeOffset+(8*(i-1)+4)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp]; 
    WaveForm_4I(2 + (i-1)*16 + 10, :) = [timeOffset+(8*(i-1)+4)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+4)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp]; 
    WaveForm_4I(2 + (i-1)*16 + 11, :) = [timeOffset+(8*(i-1)+5)*DetUnit timeOffset+(8*(i-1)+5)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp];
    WaveForm_4I(2 + (i-1)*16 + 12, :) = [timeOffset+(8*(i-1)+5)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+5)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp];
    WaveForm_4I(2 + (i-1)*16 + 13, :) = [timeOffset+(8*(i-1)+6)*DetUnit timeOffset+(8*(i-1)+6)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp]; 
    WaveForm_4I(2 + (i-1)*16 + 14, :) = [timeOffset+(8*(i-1)+6)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+6)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp]; 
    WaveForm_4I(2 + (i-1)*16 + 15, :) = [timeOffset+(8*(i-1)+7)*DetUnit timeOffset+(8*(i-1)+7)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp]; 
    WaveForm_4I(2 + (i-1)*16 + 16, :) = [timeOffset+(8*(i-1)+7)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+7)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp]; 
end
WaveForm_4Q = WaveForm_4I - repmat([0 0 0 pi/2 0], size(WaveForm_4I, 1), 1);
WaveForm_4Length = ceil((SquPi/2+SquTime+RotTime+DetPi/2+8*DetN*DetUnit+1000) / (16 / gSG3.AWGClockRate)) ...
    *(16 / gSG3.AWGClockRate);
...
function Squeezing_Double_T2XY8_SwpTheta
global gmSEQ gSG gSG2 gSG3
gSG.bfixedPow=1;
gSG.bfixedFreq=1;
gSG.bMod='IQ';
...
% Rotation parameter defintions
RotAngle = gmSEQ.m;
RotTime = DetPi + PulseGap + DoublePi;
...
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[DetPi+2*MWBuffer+6,  repelem(DetPi+2*DoublePi+2*PulseGap+2*MWBuffer, 8*DetN), ... 
    DetPi+2*MWBuffer+6,  repelem(DetPi+2*DoublePi+2*PulseGap+2*MWBuffer, 8*DetN)];
...
if gmSEQ.m == 0 
    WaveForm_1I = [0 DetPi gSG2.AWGFreq+ProbeACFreq 0 0];
else
    WaveForm_1I = zeros(2 + 8*DetN, 5);
    WaveForm_1I(1, :) = [0 DetPi/2 gSG2.AWGFreq+ProbeACFreq 0 gSG2.AWGAmp];
    for i = 1:DetN
        WaveForm_1I(1 + (i-1)*8 + 1, :) = [DetPi/2+DetInterval/2+(8*(i-1)+0)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+0)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq 0 gSG2.AWGAmp]; % pi_x
        WaveForm_1I(1 + (i-1)*8 + 2, :) = [DetPi/2+DetInterval/2+(8*(i-1)+1)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+1)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq pi/2 gSG2.AWGAmp]; % pi_y
        WaveForm_1I(1 + (i-1)*8 + 3, :) = [DetPi/2+DetInterval/2+(8*(i-1)+2)*DetUnit+DoublePi+PulseGap DetPi/2+DetInterval/2+(8*(i-1)+2)*DetUnit+DoublePi+PulseGap+DetPi gSG2.AWGFreq+ProbeACFreq 0 gSG2.AWGAmp]; % pi_x
...
% Squeezed spin 2
WaveForm_4I = zeros(2 + 16*DetN, 5);
WaveForm_4I(1, :) = [0 SquPi/2+SquTime+RotAngle+PulseGap gSG2.AWGFreq 0 0];
WaveForm_4I(2, :) = [SquPi/2+SquTime+RotAngle+PulseGap SquPi/2+SquTime+RotAngle+PulseGap+DoublePi gSG2.AWGFreq pi gSG3.AWGAmp];
timeOffset = SquPi/2+SquTime+RotTime+DetPi/2+DetInterval/2;
for i = 1:DetN
    WaveForm_4I(2 + (i-1)*16 + 1, :) = [timeOffset+(8*(i-1)+0)*DetUnit timeOffset+(8*(i-1)+0)*DetUnit+DoublePi gSG3.AWGFreq 0 gSG3.AWGAmp];
    WaveForm_4I(2 + (i-1)*16 + 2, :) = [timeOffset+(8*(i-1)+0)*DetUnit+DetPi+DoublePi+2*PulseGap  timeOffset+(8*(i-1)+0)*DetUnit+DetPi+2*DoublePi+2*PulseGap gSG3.AWGFreq pi gSG3.AWGAmp]; 
...
%          gmSEQ.halfpi+0 2*gmSEQ.halfpi+0 gSG.AWGFreq pi gSG.halfpiAWGAmp];
    ...
    if gmSEQ.CoolSwitch == 0
        if ~gmSEQ.bGo
            disp("XY8 (X Y X Y Y X Y X) sequence ongoing...")
        end
        for i = 1:gmSEQ.m
            WaveForm_1I(1 + (i-1)*8 + 1, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 2, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_y
    ...
    elseif gmSEQ.CoolSwitch == 1
        if ~gmSEQ.bGo
            disp("CPMG (Y Y) sequence ongoing...")
        end
        for i = 1:gmSEQ.m
            WaveForm_1I(1 + (i-1)*8 + 1, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 2, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 3, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+2/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+2/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 4, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+3/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+3/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 5, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+4/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+4/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 6, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 7, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 8, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
        end
    elseif gmSEQ.CoolSwitch == 2
        if ~gmSEQ.bGo
            disp("CPMG (Y Y -Y -Y) sequence ongoing...")
        end
        for i = 1:gmSEQ.m
            WaveForm_1I(1 + (i-1)*8 + 1, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 2, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 3, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+2/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+2/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 4, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+3/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+3/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 5, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+4/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+4/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 6, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 7, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 8, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_x
        end
    elseif gmSEQ.CoolSwitch == 3
        if ~gmSEQ.bGo
            disp("CPMG (Y Y Y Y -Y -Y -Y -Y) sequence ongoing...")
        end
        for i = 1:gmSEQ.m
            WaveForm_1I(1 + (i-1)*8 + 1, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 2, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_y
            ...
            WaveForm_1I(1 + (i-1)*8 + 6, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 7, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 8, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_x
        end
    else
        if ~gmSEQ.bGo
            disp("CP sequence ongoing...")
        end
        for i = 1:gmSEQ.m
            WaveForm_1I(1 + (i-1)*8 + 1, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+0/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 2, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+1/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 3, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+2/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+2/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 4, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+3/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+3/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 5, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+4/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+4/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 6, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+5/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 7, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+6/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_y
            WaveForm_1I(1 + (i-1)*8 + 8, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
        end
    end
    WaveForm_1I(2 + 8*gmSEQ.m, :) = [gmSEQ.halfpi+gmSEQ.m*Cycle gmSEQ.halfpi+gmSEQ.m*Cycle+gmSEQ.halfpi gSG.AWGFreq pi/2 gSG.halfpiAWGAmp];
end
...
% gSG.piAWGAmp = gmSEQ.SAmp1; % Just for temporary use
% gSG.halfpiAWGAmp = gmSEQ.SAmp2; % Just for temporary use
gSG.piAWGAmp = gmSEQ.SAmp1; 
gSG.halfpiAWGAmp = gmSEQ.SAmp2;

% N here is the repetition number of XY8 block
N = round(gmSEQ.CoolCycle);
...
Cycle = (gmSEQ.interval + gmSEQ.pi)*8;
Sig_D_start = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*N+gmSEQ.pi+AfterPi+Detect_Window+Wait_p;

gmSEQ.CHN(1).PBN=PBDictionary('ctr0');
gmSEQ.CHN(1).NRise=4;
gmSEQ.CHN(1).T=[Wait_p+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ...
    Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*N+gmSEQ.pi+AfterPi, ...
    Sig_D_start+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ... 
    Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*N+gmSEQ.pi+AfterPi];
if strcmp(gmSEQ.meas,'SPCM')
    gmSEQ.CHN(1).DT=[gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur];
elseif strcmp(gmSEQ.meas,'APD')
    gmSEQ.CHN(1).DT=[1000 1000 1000 1000];
...
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AOM');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=4;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [Wait_p, Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*N+gmSEQ.pi+AfterPi, ...
    Sig_D_start, Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*N+gmSEQ.pi+AfterPi];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [gmSEQ.readout Detect_Window gmSEQ.readout Detect_Window];
...
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser, ...
    Sig_D_start+gmSEQ.readout+AfterLaser];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.halfpi+Cycle*N+gmSEQ.pi+200, 2);


gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('MWSwitch');
if N == 0 || gmSEQ.interval < 100
        gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
        gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser-MWbuffer, Sig_D_start+gmSEQ.readout+AfterLaser-MWbuffer];
        gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.halfpi+Cycle*N+gmSEQ.pi+2*MWbuffer, gmSEQ.halfpi+Cycle*N+gmSEQ.pi+2*MWbuffer];
else
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2*(8*N + 2);
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = zeros(1, 2*(8*N + 2));
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1) = Wait_p+gmSEQ.readout+AfterLaser-MWbuffer;
    for i = 1:N
        for j = 1:8
         gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+(i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-MWbuffer;
    ...
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*N+1) = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+N*Cycle-MWbuffer;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*N+2) = Sig_D_start+gmSEQ.readout+AfterLaser-MWbuffer;
    for i = 1:N
        for j = 1:8
         gmSEQ.CHN(numel(gmSEQ.CHN)).T(3+8*N+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-MWbuffer;
        end
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(3+16*N+1) = Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+N*Cycle-MWbuffer;
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.halfpi+2*MWbuffer, repelem(gmSEQ.pi+2*MWbuffer, 8*N), gmSEQ.pi+2*MWbuffer, ... 
        gmSEQ.halfpi+2*MWbuffer, repelem(gmSEQ.pi+2*MWbuffer, 8*N), gmSEQ.pi+2*MWbuffer];
end
...
if N == 0
    PulseGap = 10;
    WaveForm_1I = [0 gmSEQ.halfpi gSG.AWGFreq 0 gmSEQ.m; ...
        gmSEQ.halfpi+PulseGap gmSEQ.halfpi+PulseGap+gmSEQ.halfpi gSG.AWGFreq pi/2 gSG.halfpiAWGAmp;];
else 
    WaveForm_1I = zeros(2 + 8*N, 5);
    WaveForm_1I(1, :) = [0 gmSEQ.halfpi gSG.AWGFreq 0 gmSEQ.m];
    if gmSEQ.CoolSwitch == 0
        if ~gmSEQ.bGo
            disp("XY8 (X Y X Y Y X Y X) sequence ongoing...")
        end
    ...
    WaveForm_1I(2 + 8*N, :) = [gmSEQ.halfpi+N*Cycle gmSEQ.halfpi+N*Cycle+gmSEQ.halfpi gSG.AWGFreq pi/2 gSG.halfpiAWGAmp];
    % WaveForm_1I(2 + 8*N, :) = [gmSEQ.halfpi+N*Cycle gmSEQ.halfpi+N*Cycle+gmSEQ.pi gSG.AWGFreq pi 0];
end

WaveForm_1Q = WaveForm_1I - repmat([0 0 0 pi/2 0], size(WaveForm_1I, 1), 1);
WaveForm_1Length = ceil((gmSEQ.halfpi+N*Cycle+gmSEQ.pi+1000) / (16 / gSG.AWGClockRate)) ...
    *(16 / gSG.AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length * gSG.AWGClockRate;
...
%     WaveForm_2I(size(WaveForm_1I, 1), 5) = gSG.piAWGAmp; % Differential measurement
%     WaveForm_2Q(size(WaveForm_1I, 1), 5) = gSG.piAWGAmp; % Differential measurement
WaveForm_2Length = WaveForm_1Length;
WaveForm_2PointNum = WaveForm_2Length * gSG.AWGClockRate;
...
Cycle = (gmSEQ.interval + gmSEQ.pi + 2*DoublePi + 2*PulseGap)*8;
Sig_D_start = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+Cycle*gmSEQ.m+DoublePi+PulseGap+gmSEQ.halfpi+AfterPi+Detect_Window+Wait_p;

gmSEQ.CHN(1).PBN=PBDictionary('ctr0');
gmSEQ.CHN(1).NRise=4;
gmSEQ.CHN(1).T=[Wait_p+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ...
    Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+Cycle*gmSEQ.m+DoublePi+PulseGap+gmSEQ.halfpi+AfterPi, ...
    Sig_D_start+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ... 
    Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+Cycle*gmSEQ.m+DoublePi+PulseGap+gmSEQ.halfpi+AfterPi];
if strcmp(gmSEQ.meas,'SPCM')
    gmSEQ.CHN(1).DT=[gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur];
elseif strcmp(gmSEQ.meas,'APD')
    gmSEQ.CHN(1).DT=[1000 1000 1000 1000];
...
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AOM');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=4;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [Wait_p, Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+Cycle*gmSEQ.m+DoublePi+PulseGap+gmSEQ.halfpi+AfterPi, ...
    Sig_D_start, Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+Cycle*gmSEQ.m+DoublePi+PulseGap+gmSEQ.halfpi+AfterPi];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [gmSEQ.readout Detect_Window gmSEQ.readout Detect_Window];
...
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser, ...
    Sig_D_start+gmSEQ.readout+AfterLaser];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.halfpi+PulseGap+DoublePi+Cycle*gmSEQ.m+DoublePi+PulseGap+gmSEQ.halfpi+200, 2);


gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('MWSwitch');
if gmSEQ.m == 0 ||gmSEQ.interval < 100
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser-MWbuffer, Sig_D_start+gmSEQ.readout+AfterLaser-MWbuffer];
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.halfpi+PulseGap+DoublePi+Cycle*gmSEQ.m+DoublePi+PulseGap+gmSEQ.halfpi+2*MWbuffer, 2);
else
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2*(8*gmSEQ.m + 2);
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = zeros(1, 2*(8*gmSEQ.m + 2));
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1) = Wait_p+gmSEQ.readout+AfterLaser-MWbuffer;
    for i = 1:gmSEQ.m
        for j = 1:8
         gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+(i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-MWbuffer;
        end
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*gmSEQ.m+1) = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+gmSEQ.m*Cycle-MWbuffer;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*gmSEQ.m+2) = Sig_D_start+gmSEQ.readout+AfterLaser-MWbuffer;
    for i = 1:gmSEQ.m
        for j = 1:8
         gmSEQ.CHN(numel(gmSEQ.CHN)).T(3+8*gmSEQ.m+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-MWbuffer;
        end
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(3+16*gmSEQ.m+1) = Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+PulseGap+DoublePi+gmSEQ.m*Cycle-MWbuffer;
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.halfpi+PulseGap+DoublePi+2*MWbuffer, repelem(gmSEQ.pi+2*DoublePi+2*PulseGap+2*MWbuffer, 8*gmSEQ.m), gmSEQ.halfpi+PulseGap+DoublePi+2*MWbuffer, ... 
        gmSEQ.halfpi+PulseGap+DoublePi+2*MWbuffer, repelem(gmSEQ.pi+2*DoublePi+2*PulseGap+2*MWbuffer, 8*gmSEQ.m), gmSEQ.halfpi+PulseGap+DoublePi+2*MWbuffer];
end
...
% else
    WaveForm_1I = zeros(2 + 8*gmSEQ.m, 5);
    WaveForm_1I(1, :) = [0 gmSEQ.halfpi gSG.AWGFreq 0 gSG.halfpiAWGAmp];
    offset = gmSEQ.halfpi+PulseGap+DoublePi+gmSEQ.interval/2+DoublePi+PulseGap;
    if gmSEQ.CoolSwitch == 0
        if ~gmSEQ.bGo
            disp("XY8 sequence ongoing...")
        end
        for i = 1:gmSEQ.m
            WaveForm_1I(1 + (i-1)*8 + 1, :) = [offset+(i-1+0/8)*Cycle offset+(i-1+1/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 2, :) = [offset+(i-1+1/8)*Cycle offset+(i-1+2/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 3, :) = [offset+(i-1+2/8)*Cycle offset+(i-1+3/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 4, :) = [offset+(i-1+3/8)*Cycle offset+(i-1+4/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 5, :) = [offset+(i-1+4/8)*Cycle offset+(i-1+5/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 6, :) = [offset+(i-1+5/8)*Cycle offset+(i-1+6/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 7, :) = [offset+(i-1+6/8)*Cycle offset+(i-1+7/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 8, :) = [offset+(i-1+7/8)*Cycle offset+(i-1+8/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
        end
    elseif gmSEQ.CoolSwitch == 1
        if ~gmSEQ.bGo
            disp("CPMG sequence ongoing...")
        end
        for i = 1:gmSEQ.m
            WaveForm_1I(1 + (i-1)*8 + 1, :) = [offset+(i-1+0/8)*Cycle offset+(i-1+1/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 2, :) = [offset+(i-1+1/8)*Cycle offset+(i-1+2/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 3, :) = [offset+(i-1+2/8)*Cycle offset+(i-1+3/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 4, :) = [offset+(i-1+3/8)*Cycle offset+(i-1+4/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 5, :) = [offset+(i-1+4/8)*Cycle offset+(i-1+5/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 6, :) = [offset+(i-1+5/8)*Cycle offset+(i-1+6/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 7, :) = [offset+(i-1+6/8)*Cycle offset+(i-1+7/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 8, :) = [offset+(i-1+7/8)*Cycle offset+(i-1+8/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x        
        end
    elseif gmSEQ.CoolSwitch == 2
        if ~gmSEQ.bGo
            disp("CPMG 2 sequence ongoing...")
        end
        for i = 1:gmSEQ.m
            WaveForm_1I(1 + (i-1)*8 + 1, :) = [offset+(i-1+0/8)*Cycle offset+(i-1+1/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 2, :) = [offset+(i-1+1/8)*Cycle offset+(i-1+2/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 3, :) = [offset+(i-1+2/8)*Cycle offset+(i-1+3/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 4, :) = [offset+(i-1+3/8)*Cycle offset+(i-1+4/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 5, :) = [offset+(i-1+4/8)*Cycle offset+(i-1+5/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 6, :) = [offset+(i-1+5/8)*Cycle offset+(i-1+6/8)*Cycle+gmSEQ.pi gSG.AWGFreq pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 7, :) = [offset+(i-1+6/8)*Cycle offset+(i-1+7/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_x
            WaveForm_1I(1 + (i-1)*8 + 8, :) = [offset+(i-1+7/8)*Cycle offset+(i-1+8/8)*Cycle+gmSEQ.pi gSG.AWGFreq 3*pi/2 gSG.piAWGAmp]; % pi_x  
        end
    end
    WaveForm_1I(2 + 8*gmSEQ.m, :) = [gmSEQ.halfpi+PulseGap+DoublePi+gmSEQ.m*Cycle+DoublePi+PulseGap gmSEQ.halfpi+gmSEQ.m*Cycle+DoublePi+PulseGap+gmSEQ.halfpi gSG.AWGFreq pi/2 gSG.halfpiAWGAmp];
% end

WaveForm_1Q = WaveForm_1I - repmat([0 0 0 pi/2 0], size(WaveForm_1I, 1), 1);
WaveForm_1Length = ceil((gmSEQ.halfpi+PulseGap+DoublePi+gmSEQ.m*Cycle+DoublePi+PulseGap+gmSEQ.halfpi+1000) / (16 / gSG.AWGClockRate)) ...
    *(16 / gSG.AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length * gSG.AWGClockRate;
...
WaveForm_3I = zeros(3 + 16*gmSEQ.m, 5);
WaveForm_3I(1, :) = [0 gmSEQ.halfpi gSG.AWGFreq 0 0];
WaveForm_3I(2, :) = [gmSEQ.halfpi+PulseGap gmSEQ.halfpi+PulseGap+DoublePi gSG.AWGFreq 0 gSG3.AWGAmp];
for i = 1:gmSEQ.m
    WaveForm_3I(2 + (i-1)*16 + 1, :) = [offset-PulseGap-DoublePi+(i-1+0/8)*Cycle offset-PulseGap+(i-1+0/8)*Cycle gSG.AWGFreq pi gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 2, :) = [offset+gmSEQ.pi+PulseGap+(i-1+0/8)*Cycle offset+gmSEQ.pi+PulseGap+DoublePi+(i-1+0/8)*Cycle gSG.AWGFreq 0 gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 3, :) = [offset-PulseGap-DoublePi+(i-1+1/8)*Cycle offset-PulseGap+(i-1+1/8)*Cycle gSG.AWGFreq pi gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 4, :) = [offset+gmSEQ.pi+PulseGap+(i-1+1/8)*Cycle offset+gmSEQ.pi+PulseGap+DoublePi+(i-1+1/8)*Cycle gSG.AWGFreq 0 gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 5, :) = [offset-PulseGap-DoublePi+(i-1+2/8)*Cycle offset-PulseGap+(i-1+2/8)*Cycle gSG.AWGFreq pi gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 6, :) = [offset+gmSEQ.pi+PulseGap+(i-1+2/8)*Cycle offset+gmSEQ.pi+PulseGap+DoublePi+(i-1+2/8)*Cycle gSG.AWGFreq 0 gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 7, :) = [offset-PulseGap-DoublePi+(i-1+3/8)*Cycle offset-PulseGap+(i-1+3/8)*Cycle gSG.AWGFreq pi gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 8, :) = [offset+gmSEQ.pi+PulseGap+(i-1+3/8)*Cycle offset+gmSEQ.pi+PulseGap+DoublePi+(i-1+3/8)*Cycle gSG.AWGFreq 0 gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 9, :) = [offset-PulseGap-DoublePi+(i-1+4/8)*Cycle offset-PulseGap+(i-1+4/8)*Cycle gSG.AWGFreq pi gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 10, :) = [offset+gmSEQ.pi+PulseGap+(i-1+4/8)*Cycle offset+gmSEQ.pi+PulseGap+DoublePi+(i-1+4/8)*Cycle gSG.AWGFreq 0 gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 11, :) = [offset-PulseGap-DoublePi+(i-1+5/8)*Cycle offset-PulseGap+(i-1+5/8)*Cycle gSG.AWGFreq pi gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 12, :) = [offset+gmSEQ.pi+PulseGap+(i-1+5/8)*Cycle offset+gmSEQ.pi+PulseGap+DoublePi+(i-1+5/8)*Cycle gSG.AWGFreq 0 gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 13, :) = [offset-PulseGap-DoublePi+(i-1+6/8)*Cycle offset-PulseGap+(i-1+6/8)*Cycle gSG.AWGFreq pi gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 14, :) = [offset+gmSEQ.pi+PulseGap+(i-1+6/8)*Cycle offset+gmSEQ.pi+PulseGap+DoublePi+(i-1+6/8)*Cycle gSG.AWGFreq 0 gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 15, :) = [offset-PulseGap-DoublePi+(i-1+7/8)*Cycle offset-PulseGap+(i-1+7/8)*Cycle gSG.AWGFreq pi gSG3.AWGAmp]; % pi_x
    WaveForm_3I(2 + (i-1)*16 + 16, :) = [offset+gmSEQ.pi+PulseGap+(i-1+7/8)*Cycle offset+gmSEQ.pi+PulseGap+DoublePi+(i-1+7/8)*Cycle gSG.AWGFreq 0 gSG3.AWGAmp]; % pi_x
end
WaveForm_3Q = WaveForm_3I - repmat([0 0 0 pi/2 0], size(WaveForm_3I, 1), 1);
WaveForm_3Length = ceil((gmSEQ.halfpi+PulseGap+DoublePi+gmSEQ.m*Cycle+DoublePi+PulseGap+gmSEQ.halfpi+1000) / (16 / gSG.AWGClockRate)) ...
    *(16 / gSG.AWGClockRate);
WaveForm_3PointNum = WaveForm_3Length * gSG.AWGClockRate;
...
chaseFunctionPool('createSegStruct', 'XY8N_SegStruct_H_I.txt', ...
    'Echo_I_seg3.txt', WaveForm_3PointNum, 1, 1, ...
    'Echo_I_seg3.txt', WaveForm_3PointNum, 1, 1);
pause(0.5);
chaseFunctionPool('createSegStruct', 'XY8N_SegStruct_H_Q.txt', ...
    'Echo_Q_seg3.txt', WaveForm_3PointNum, 1, 1, ...
    'Echo_Q_seg3.txt', WaveForm_3PointNum, 1, 1);
pause(0.5);
...
chaseFunctionPool('CreateSegments', gmSEQ.MWAWG2, 1, ...
    2, ...
    2047, 2047, 'XY8N_SegStruct_H_I.txt', 'false');
pause(1); % this pause seems to be important, otherwise the loading is not right occassionally
chaseFunctionPool('CreateSegments', gmSEQ.MWAWG2, 2, ...
    2, ...
    2047, 2047, 'XY8N_SegStruct_H_Q.txt', 'false');
pause(1); % this pause seems to be important, otherwise the loading is not right occassionally
...
gmSEQ.CHN(1).PBN=PBDictionary('AOM');
gmSEQ.CHN(1).NRise=2;
gmSEQ.CHN(1).T=[0 gmSEQ.readout+delay+gmSEQ.DEERpi+afterPulse];
gmSEQ.CHN(1).DT=[gmSEQ.readout 5000];

gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('ctr0');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[gmSEQ.readout-1000-gmSEQ.CtrGateDur gmSEQ.readout+delay+gmSEQ.DEERpi+afterPulse];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.CtrGateDur gmSEQ.CtrGateDur];

gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('MWSwitch');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=1;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[gmSEQ.readout+delay-bufferTime2-bufferTime];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.DEERpi+2*bufferTime2+2*bufferTime];

gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('MWSwitch2');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=1;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[gmSEQ.readout+delay-bufferTime];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.DEERpi+2*bufferTime];
...
gmSEQ.CHN(numel(gmSEQ.CHN) + 1).PBN = PBDictionary('AWGTrig');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 1;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = gmSEQ.readout + delay - bufferTime2;
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = 200;
...
WaveForm_1I = [0, gmSEQ.DEERpi, gSG2.AWGFreq, 0, gSG2.AWGAmp];
WaveForm_1Q = [0, gmSEQ.DEERpi, gSG2.AWGFreq, -pi/2, gSG2.AWGAmp];
WaveForm_1Length = ceil((gmSEQ.DEERpi + 1000) / (16/gSG2.P1AWGClockRate)) * (16/gSG2.P1AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length*gSG2.P1AWGClockRate;

WaveForm_2I = [0, gmSEQ.DEERpi+2*bufferTime2, gSG.AWGFreq, 0, gSG.AWGAmp];
WaveForm_2Q = [0, gmSEQ.DEERpi+2*bufferTime2, gSG.AWGFreq, -pi/2, gSG.AWGAmp];
WaveForm_2Length = ceil((gmSEQ.DEERpi +2*bufferTime2 + 1000) / (16/gSG.AWGClockRate)) * (16/gSG.AWGClockRate);
WaveForm_2PointNum = WaveForm_2Length*gSG.AWGClockRate;


chaseFunctionPool('createWaveform', WaveForm_1I, ...
    gSG2.P1AWGClockRate, WaveForm_1Length, 'ODMR_Ch1.txt')
chaseFunctionPool('createWaveform', WaveForm_1Q, ... 
    gSG2.P1AWGClockRate, WaveForm_1Length, 'ODMR_Ch2.txt')
chaseFunctionPool('createWaveform', WaveForm_2I, ...
    gSG.AWGClockRate, WaveForm_2Length, 'ODMR_Ch3.txt')
chaseFunctionPool('createWaveform', WaveForm_2Q, ... 
    gSG.AWGClockRate, WaveForm_2Length, 'ODMR_Ch4.txt')


chaseFunctionPool('CreateSingleSegment', gmSEQ.P1AWG, 1, ...
    WaveForm_1PointNum, 1, 2047, 2047, 'ODMR_Ch1.txt', 1); 
pause(1.0);
chaseFunctionPool('CreateSingleSegment', gmSEQ.P1AWG, 2, ...
    WaveForm_1PointNum, 1, 2047, 2047, 'ODMR_Ch2.txt', 1);
pause(1.0);
chaseFunctionPool('CreateSingleSegment', gmSEQ.MWAWG, 1, ...
    WaveForm_2PointNum, 1, 2047, 2047, 'ODMR_Ch3.txt', 1); 
pause(1.0);
chaseFunctionPool('CreateSingleSegment', gmSEQ.MWAWG, 2, ...
    WaveForm_2PointNum, 1, 2047, 2047, 'ODMR_Ch4.txt', 1);
pause(1.0);
...
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=1;
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[gmSEQ.readout+delay-bufferTime2-bufferTime];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.pi+2*bufferTime2+2*bufferTime];
...
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 1;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = gmSEQ.readout + delay - bufferTime2;
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = gmSEQ.pi+2*bufferTime2+4*bufferTime;

gmSEQ.CHN(numel(gmSEQ.CHN) + 1).PBN = PBDictionary('AWGTrig');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 1;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = gmSEQ.readout + delay;
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = gmSEQ.pi+4*bufferTime;
...
WaveForm_1I = [0, gmSEQ.pi, gSG.AWGFreq, 0, gSG.AWGAmp];
WaveForm_1Q = [0, gmSEQ.pi, gSG.AWGFreq, -pi/2, gSG.AWGAmp];
WaveForm_1Length = ceil((gmSEQ.pi + 1000) / (16/gSG.AWGClockRate)) * (16/gSG.AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length*gSG.AWGClockRate;

WaveForm_2I = [0, gmSEQ.pi+2*bufferTime2, gSG2.AWGFreq, 0, gSG2.AWGAmp];
WaveForm_2Q = [0, gmSEQ.pi+2*bufferTime2, gSG2.AWGFreq, -pi/2, gSG2.AWGAmp];
WaveForm_2Length = ceil((gmSEQ.pi + 1000) / (16/gSG2.P1AWGClockRate)) * (16/gSG2.P1AWGClockRate);
WaveForm_2PointNum = WaveForm_2Length*gSG2.P1AWGClockRate;


chaseFunctionPool('createWaveform', WaveForm_1I, ...
    gSG.AWGClockRate, WaveForm_1Length, 'ODMR_Ch1.txt')
chaseFunctionPool('createWaveform', WaveForm_1Q, ... 
    gSG.AWGClockRate, WaveForm_1Length, 'ODMR_Ch2.txt')
chaseFunctionPool('createWaveform', WaveForm_2I, ...
    gSG2.P1AWGClockRate, WaveForm_2Length, 'ODMR_Ch3.txt')
chaseFunctionPool('createWaveform', WaveForm_2Q, ... 
    gSG2.P1AWGClockRate, WaveForm_2Length, 'ODMR_Ch4.txt')
...
% XY8N here is the repetition number of XY8 block
XY8N = round(gmSEQ.CoolCycle);
...
Cycle = (gmSEQ.interval + gmSEQ.pi)*8;
Sig_D_start = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*XY8N+gmSEQ.halfpi+AfterPi+Detect_Window+Wait_p;

gmSEQ.CHN(1).PBN=PBDictionary('ctr0');
gmSEQ.CHN(1).NRise=4;
gmSEQ.CHN(1).T=[Wait_p+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ...
    Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*XY8N+gmSEQ.halfpi+AfterPi, ...
    Sig_D_start+gmSEQ.readout-1000-gmSEQ.CtrGateDur, ... 
    Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*XY8N+gmSEQ.halfpi+AfterPi];
if strcmp(gmSEQ.meas,'SPCM')
    gmSEQ.CHN(1).DT=[gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur gmSEQ.CtrGateDur];
elseif strcmp(gmSEQ.meas,'APD')
    gmSEQ.CHN(1).DT=[1000 1000 1000 1000];
...
gmSEQ.CHN(numel(gmSEQ.CHN)+1).PBN=PBDictionary('AOM');
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=4;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [Wait_p, Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*XY8N+gmSEQ.halfpi+AfterPi, ...
    Sig_D_start, Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+Cycle*XY8N+gmSEQ.halfpi+AfterPi];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [gmSEQ.readout Detect_Window gmSEQ.readout Detect_Window];
...
gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser, ...
    Sig_D_start+gmSEQ.readout+AfterLaser];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT=repelem(gmSEQ.halfpi+Cycle*XY8N+gmSEQ.halfpi+200, 2);
...
if XY8N == 0
    ...
    if gmSEQ.interval < 100
        gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2;
        gmSEQ.CHN(numel(gmSEQ.CHN)).T=[Wait_p+gmSEQ.readout+AfterLaser-MWbuffer, Sig_D_start+gmSEQ.readout+AfterLaser-MWbuffer];
        gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.halfpi+Cycle*XY8N+gmSEQ.halfpi+2*MWbuffer, gmSEQ.halfpi+Cycle*XY8N+gmSEQ.halfpi+2*MWbuffer];
    else
        gmSEQ.CHN(numel(gmSEQ.CHN)).NRise=2*(8*XY8N + 2);
        gmSEQ.CHN(numel(gmSEQ.CHN)).T = zeros(1, 2*(8*XY8N + 2));
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(1) = Wait_p+gmSEQ.readout+AfterLaser-MWbuffer;
        for i = 1:XY8N
            for j = 1:8
             gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+(i-1)*8+j) = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-MWbuffer;
        ...
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*XY8N+1) = Wait_p+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+XY8N*Cycle-MWbuffer;
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(1+8*XY8N+2) = Sig_D_start+gmSEQ.readout+AfterLaser-MWbuffer;
        for i = 1:XY8N
            for j = 1:8
             gmSEQ.CHN(numel(gmSEQ.CHN)).T(3+8*XY8N+(i-1)*8+j) = Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+gmSEQ.interval/2+(i-1+(j-1)/8)*Cycle-MWbuffer;
            end
        end
        gmSEQ.CHN(numel(gmSEQ.CHN)).T(3+16*XY8N+1) = Sig_D_start+gmSEQ.readout+AfterLaser+gmSEQ.halfpi+XY8N*Cycle-MWbuffer;
        gmSEQ.CHN(numel(gmSEQ.CHN)).DT=[gmSEQ.halfpi+2*MWbuffer, repelem(gmSEQ.pi+2*MWbuffer, 8*XY8N), gmSEQ.halfpi+2*MWbuffer, ... 
            gmSEQ.halfpi+2*MWbuffer, repelem(gmSEQ.pi+2*MWbuffer, 8*XY8N), gmSEQ.halfpi+2*MWbuffer];
    end
end
...
%         WaveForm_1I(1 + (i-1)*8 + 8, :) = [gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle gmSEQ.halfpi+gmSEQ.interval/2+(i-1+7/8)*Cycle+gmSEQ.pi gSG.AWGFreq 0 gSG.piAWGAmp]; % pi_x
    ...
    WaveForm_1I(2 + 8*XY8N, :) = [gmSEQ.halfpi+XY8N*Cycle gmSEQ.halfpi+XY8N*Cycle+gmSEQ.halfpi gSG.AWGFreq pi gSG.halfpiAWGAmp];
    % WaveForm_1I(2 + 8*XY8N, :) = [gmSEQ.halfpi+XY8N*Cycle gmSEQ.halfpi+XY8N*Cycle+gmSEQ.halfpi gSG.AWGFreq pi 0];
end
WaveForm_1Q = WaveForm_1I - repmat([0 0 0 pi/2 0], size(WaveForm_1I, 1), 1);
WaveForm_1Length = ceil((gmSEQ.halfpi+XY8N*Cycle+gmSEQ.halfpi+1000) / (16 / gSG.AWGClockRate)) ...
    *(16 / gSG.AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length * gSG.AWGClockRate;
...
T_AfterLaser = 2000;
T_AfterPulse = 1000;
N = round(gmSEQ.m); % The number of calibration pulses
...
if N ~= 0
    ...
    for i = 1:N
        WaveForm_I(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.pi, gSG.AWGFreq, 0, gSG.AWGAmp];
        WaveForm_Q(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.pi, gSG.AWGFreq, -pi/2, gSG.AWGAmp];
    end
...
T_AfterPulse = 1000;
N = round(gmSEQ.m); % The number of calibration pulses
T_Cycle = 2*(gmSEQ.pi + gmSEQ.interval); % Time for a single pulse
...
if N ~= 0
    ...
    if bSwitch
        buffer = 20;
        gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 2*N;
        gmSEQ.CHN(numel(gmSEQ.CHN)).T = [];
        for i = 1:N
           gmSEQ.CHN(numel(gmSEQ.CHN)).T(2*(i-1)+1) = gmSEQ.readout + T_AfterLaser + (i-1) * T_Cycle - buffer;
           gmSEQ.CHN(numel(gmSEQ.CHN)).T(2*(i-1)+2) = gmSEQ.readout + T_AfterLaser + (i-0.5) * T_Cycle - buffer;
        end
        gmSEQ.CHN(numel(gmSEQ.CHN)).DT = repelem(gmSEQ.pi + 2*buffer, 2*N);
    else
        buffer = 20;
        gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 1;
        gmSEQ.CHN(numel(gmSEQ.CHN)).T = [gmSEQ.readout + T_AfterLaser - buffer];
...
if N ~= 0
    WaveForm_I = zeros(2*N, 5);
    for i = 1:N
        WaveForm_I(2*(i-1)+1,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.pi, gSG.AWGFreq, 0, gSG.AWGAmp];
        WaveForm_I(2*(i-1)+2,:) = [(i-0.5)*T_Cycle, (i-0.5)*T_Cycle + gmSEQ.pi, gSG.AWGFreq, pi/2, gSG.AWGAmp];
    end
    WaveForm_Q = WaveForm_I - repmat([0 0 0 pi/2 0], size(WaveForm_I, 1), 1);
    WaveForm_Length = ceil((N*T_Cycle + 1000) / (16/gSG.AWGClockRate)) * (16/gSG.AWGClockRate);
    WaveForm_PointNum = WaveForm_Length*gSG.AWGClockRate;
...
if bSwitch
    ...
    for i = 1:N
       gmSEQ.CHN(numel(gmSEQ.CHN)).T(i) = gmSEQ.readout + T_AfterLaser + (i-1) * T_Cycle - buffer; 
       gmSEQ.CHN(numel(gmSEQ.CHN)).T(N + i) = Sig_D_start + gmSEQ.readout + T_AfterLaser + (i-1) * T_Cycle - buffer; 
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).T(2*N+1) = Sig_D_start + gmSEQ.readout + T_AfterLaser + N * T_Cycle - buffer;
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [repelem(gmSEQ.halfpi + 2*buffer, 2*N), gmSEQ.pi + 2*buffer];
else
    buffer = 200;
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 2;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = [gmSEQ.readout + T_AfterLaser - buffer, ... 
...
for i = 1:N
    WaveForm_1I(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.halfpi, gSG.AWGFreq, 0, gSG.halfpiAWGAmp];
    WaveForm_1Q(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.halfpi, gSG.AWGFreq, -pi/2, gSG.halfpiAWGAmp];
end
...
T_AfterPulse = 2000; % 1000 before
N = round(gmSEQ.m); % The number of calibration pulses
T_Cycle = 2*(gmSEQ.halfpi + gmSEQ.interval); % Time for a single pulse
Detect_Window = 5000; 
Wait = 1000;
Sig_D_start = gmSEQ.readout + T_AfterLaser + N * T_Cycle + T_AfterPulse + Detect_Window + Wait;
buffer = 20;
...
gmSEQ.CHN(1).T = [gmSEQ.readout - gmSEQ.CtrGateDur - 1000, ...
    gmSEQ.readout + T_AfterLaser + N*T_Cycle + T_AfterPulse, ...
    Sig_D_start + gmSEQ.readout - gmSEQ.CtrGateDur - 1000, ...
    Sig_D_start + gmSEQ.readout + T_AfterLaser + N*T_Cycle + T_AfterPulse];
gmSEQ.CHN(1).DT = repelem(gmSEQ.CtrGateDur, 4);
...
gmSEQ.CHN(numel(gmSEQ.CHN) + 1).PBN = PBDictionary('MWSwitch');
if bSwitch
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 4*N;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = zeros(1, gmSEQ.CHN(numel(gmSEQ.CHN)).NRise);
    for i = 1:N
       gmSEQ.CHN(numel(gmSEQ.CHN)).T(2*(i-1)+1) = gmSEQ.readout + T_AfterLaser + (i-1) * T_Cycle - buffer; 
       gmSEQ.CHN(numel(gmSEQ.CHN)).T(2*(i-1)+2) = gmSEQ.readout + T_AfterLaser + (i-0.5) * T_Cycle - buffer; 
       gmSEQ.CHN(numel(gmSEQ.CHN)).T(2*N+2*(i-1)+1) = Sig_D_start + gmSEQ.readout + T_AfterLaser + (i-1) * T_Cycle - buffer; 
       gmSEQ.CHN(numel(gmSEQ.CHN)).T(2*N+2*(i-1)+2) = Sig_D_start + gmSEQ.readout + T_AfterLaser + (i-0.5) * T_Cycle - buffer; 
    end
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT = repelem(gmSEQ.halfpi + 2*buffer, 2*N);
else
    buffer = 200;
    gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 2;
    gmSEQ.CHN(numel(gmSEQ.CHN)).T = [gmSEQ.readout + T_AfterLaser - buffer, ... 
        Sig_D_start + gmSEQ.readout + T_AfterLaser - buffer; ];
    gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [N * T_Cycle + 2*buffer, N * T_Cycle + 2*buffer];
end
...
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 4;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [0, gmSEQ.readout + T_AfterLaser + N*T_Cycle + T_AfterPulse, ... 
    Sig_D_start, Sig_D_start + gmSEQ.readout + T_AfterLaser + N*T_Cycle + T_AfterPulse];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [gmSEQ.readout, Detect_Window, gmSEQ.readout, Detect_Window];
...
gmSEQ.CHN(numel(gmSEQ.CHN)).NRise = 2;
gmSEQ.CHN(numel(gmSEQ.CHN)).T = [gmSEQ.readout + T_AfterLaser, Sig_D_start + gmSEQ.readout + T_AfterLaser];
gmSEQ.CHN(numel(gmSEQ.CHN)).DT = [N*T_Cycle + 200, N*T_Cycle  + 200];
...
WaveForm_1I = zeros(2*N, 5);
WaveForm_2I = zeros(2*N, 5);
for i = 1:N
    WaveForm_1I(2*(i-1)+1,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.halfpi, gSG.AWGFreq, 0, gSG.halfpiAWGAmp];
    WaveForm_1I(2*(i-1)+2,:) = [(i-0.5)*T_Cycle, (i-0.5)*T_Cycle + gmSEQ.halfpi, gSG.AWGFreq, pi/2, gSG.halfpiAWGAmp];
    WaveForm_2I(2*(i-1)+1,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.halfpi, gSG.AWGFreq, 0, gSG.halfpiAWGAmp];
    WaveForm_2I(2*(i-1)+2,:) = [(i-0.5)*T_Cycle, (i-0.5)*T_Cycle + gmSEQ.halfpi, gSG.AWGFreq, 3*pi/2, gSG.halfpiAWGAmp];
end
...
WaveForm_2Q = WaveForm_2I - repmat([0 0 0 pi/2 0], size(WaveForm_2I, 1), 1);
WaveForm_2Length = WaveForm_1Length;
WaveForm_2PointNum = WaveForm_1PointNum;
...
WaveForm_1I = zeros(N, 5);
WaveForm_1Q = zeros(N, 5);
WaveForm_2I = zeros(N, 5);
WaveForm_2Q = zeros(N, 5);
for i = 1:N
    WaveForm_1I(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.pi, gSG.AWGFreq, 0, gmSEQ.m];
    WaveForm_1Q(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.pi, gSG.AWGFreq, -pi/2, gmSEQ.m];
    WaveForm_2I(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.pi, gSG2.AWGFreq, 0, gSG2.AWGAmp];
    WaveForm_2Q(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.pi, gSG2.AWGFreq, -pi/2, gSG2.AWGAmp];
end
WaveForm_1Length = ceil((N*T_Cycle + 1000) / (16/gSG.AWGClockRate)) * (16/gSG.AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length*gSG.AWGClockRate;
WaveForm_2Length = ceil((N*T_Cycle + 1000) / (16/gSG2.P1AWGClockRate)) * (16/gSG2.P1AWGClockRate);
WaveForm_2PointNum = WaveForm_2Length*gSG2.P1AWGClockRate;
...
chaseFunctionPool('createWaveform', WaveForm_1I, ...
    gSG.AWGClockRate, WaveForm_1Length, 'Pi_Cal_I.txt')
chaseFunctionPool('createWaveform', WaveForm_1Q,  ...
    gSG.AWGClockRate, WaveForm_1Length, 'Pi_Cal_Q.txt')
chaseFunctionPool('createWaveform', WaveForm_2I, ...
    gSG2.P1AWGClockRate, WaveForm_2Length, 'Pi_Cal_I_2.txt')
chaseFunctionPool('createWaveform', WaveForm_2Q,  ...
    gSG2.P1AWGClockRate, WaveForm_2Length, 'Pi_Cal_Q_2.txt')

chaseFunctionPool('createSegStruct', 'Pi_Cal_SegStruct_I.txt', ...
    'Pi_Cal_I.txt', WaveForm_1PointNum, 1, 1);
pause(0.5);
chaseFunctionPool('createSegStruct', 'Pi_Cal_SegStruct_Q.txt', ...
    'Pi_Cal_Q.txt', WaveForm_1PointNum, 1, 1);
pause(0.5);
chaseFunctionPool('createSegStruct', 'Pi_Cal_SegStruct_I_2.txt', ...
    'Pi_Cal_I_2.txt', WaveForm_2PointNum, 1, 1);
pause(0.5);
chaseFunctionPool('createSegStruct', 'Pi_Cal_SegStruct_Q_2.txt', ...
    'Pi_Cal_Q_2.txt', WaveForm_2PointNum, 1, 1);
pause(0.5);
...
chaseFunctionPool('CreateSegments', gmSEQ.P1AWG, 1, ...
    1, ...
    2047, 2047, 'Pi_Cal_SegStruct_I_2.txt', 'false');
pause(1); % this pause seems to be important, otherwise the loading is not right occassionally
chaseFunctionPool('CreateSegments', gmSEQ.P1AWG, 2, ...
    1, ...
    2047, 2047, 'Pi_Cal_SegStruct_Q_2.txt', 'false');
pause(1); % this pause seems to be important, otherwise the loading is not right occassionally

chaseFunctionPool('runChase', gmSEQ.MWAWG, 'false'); pause(0.5);
chaseFunctionPool('runChase', gmSEQ.P1AWG, 'false'); pause(0.5);
ApplyDelays();
...
WaveForm_2Q = zeros(N, 5);
for i = 1:N
    WaveForm_1I(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.DEERpi, gSG2.AWGFreq, 0, gmSEQ.m];
    WaveForm_1Q(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.DEERpi, gSG2.AWGFreq, -pi/2, gmSEQ.m];
    WaveForm_2I(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.DEERpi, gSG.AWGFreq, 0, gSG.AWGAmp];
    WaveForm_2Q(i,:) = [(i-1)*T_Cycle, (i-1)*T_Cycle + gmSEQ.DEERpi, gSG.AWGFreq, -pi/2, gSG.AWGAmp];
end
WaveForm_1Length = ceil((N*T_Cycle + 1000) / (16/gSG2.P1AWGClockRate)) * (16/gSG2.P1AWGClockRate);
WaveForm_1PointNum = WaveForm_1Length*gSG2.P1AWGClockRate;
WaveForm_2Length = ceil((N*T_Cycle + 1000) / (16/gSG.AWGClockRate)) * (16/gSG.AWGClockRate);
WaveForm_2PointNum = WaveForm_2Length*gSG.AWGClockRate;
...
chaseFunctionPool('createWaveform', WaveForm_1I, ...
    gSG2.P1AWGClockRate, WaveForm_1Length, 'Pi_Cal_I.txt')
chaseFunctionPool('createWaveform', WaveForm_1Q,  ...
    gSG2.P1AWGClockRate, WaveForm_1Length, 'Pi_Cal_Q.txt')
chaseFunctionPool('createWaveform', WaveForm_2I, ...
    gSG.AWGClockRate, WaveForm_2Length, 'Pi_Cal_I_2.txt')
chaseFunctionPool('createWaveform', WaveForm_2Q,  ...
    gSG.AWGClockRate, WaveForm_2Length, 'Pi_Cal_Q_2.txt')
