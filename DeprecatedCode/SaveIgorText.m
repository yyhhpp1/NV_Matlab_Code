...
organized=[gmSEQ.SweepParam(~isnan(gmSEQ.signal)); gmSEQ.signal(~isnan(gmSEQ.signal)); gmSEQ.reference(~isnan(gmSEQ.reference))];

if gmSEQ.ctrN==3
    organized=[organized;  gmSEQ.reference2(~isnan(gmSEQ.reference2))];
end
if gmSEQ.ctrN==4
    organized=[organized;  gmSEQ.reference2(~isnan(gmSEQ.reference2)); gmSEQ.reference3(~isnan(gmSEQ.reference3))];
end
