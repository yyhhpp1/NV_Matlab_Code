...
%           calllib('EO0x2DDrive', 'EO_Move', handle, Voltage)
...
%        end
        ...
        maximumPosition = 100;
        minimumPosition = 0;
        if Voltage > maximumPosition
            Voltage = maximumPosition;
        end
        if Voltage < minimumPosition
            Voltage = minimumPosition;
        end
...
% %                 Voltage = 0;
% %             end
%             %calllib('EO0x2DDrive','EO_Move', EO_handle, Voltage); 
% 
% %             calllib('EO0x2DDrive','EO_Move', EO_handle, Voltage);
%             % #EO
% %             return;
