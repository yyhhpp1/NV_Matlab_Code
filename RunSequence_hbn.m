...
if gmSEQ.bCust
    ...
    gmSEQ.SweepParam = [0 linspace(50, 20050, 5), linspace(40000, 100000, 4), linspace(150000, 400000, 6), linspace(500000, 1000000, 6)];
    ...
    if gmSEQ.bTomo
        ...
        elseif gmSEQ.ctrN==4
            ...
            elseif strcmp(gmSEQ.name,'CtrDur') && gmSEQ.meas == "SPCM"
                ...
                data_err = data .* 0;
            elseif strcmp(gmSEQ.name,'Elec_Pol_Extract')
                sig1 = signal(2,:);
                ref1 = signal(1,:);
                data1 = sig1./ref1;
...
%             disp(RawData1(i:gmSEQ.ctrN:end))
%             disp('sigDatum')
%             disp(sigDatum(i))
        end
    end
