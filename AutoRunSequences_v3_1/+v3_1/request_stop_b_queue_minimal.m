function request_stop_b_queue_minimal(runtimeCtx)
%REQUEST_STOP_B_QUEUE_MINIMAL Request stop for v3_1.run_b_queue_minimal.
%   v3_1.request_stop_b_queue_minimal()
