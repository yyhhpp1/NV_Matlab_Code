...
gauss_to_current = [0.00261072, 0.00156663, 0.00673747];

% Define current search grid (example range)
I_start = [0.3, 0.1, 1.3475];
I_end   = [0.7, 0.5, 1.3475];
nI      = [5, 5, 1];   % number of points along each axis
