...
if gSG.ACmodAWG 
    ...
    if XY8Num>0
        ...
        C_1 = [C_1; ...
            gmSEQ.halfpi+wind_t gmSEQ.halfpi+wind_t+gmSEQ.halfpi gSG.AWGFreq 3*pi/2 gSG.AWGAmp]; 
        C_2 = [C_1; ...
        ...
        C_1 = [C_1;...
                2*gmSEQ.halfpi+wind_t+XY8Num*(gmSEQ.interval+gmSEQ.pi)+gmSEQ.pi+AfterPi2 2*gmSEQ.halfpi+wind_t+XY8Num*(gmSEQ.interval+gmSEQ.pi)+gmSEQ.pi+AfterPi2+gmSEQ.halfpi gSG.AWGFreq 3*pi/2 gSG.AWGAmp];
        C_2 = [C_2;...
        ...
        % -Y: bright
        C_1 = [C_1;...
                2*gmSEQ.halfpi+wind_t+XY8Num*(gmSEQ.interval+gmSEQ.pi)+gmSEQ.pi+AfterPi2+gmSEQ.halfpi+unwind_t 2*gmSEQ.halfpi+wind_t+XY8Num*(gmSEQ.interval+gmSEQ.pi)+gmSEQ.pi+AfterPi2+gmSEQ.halfpi+unwind_t+gmSEQ.halfpi gSG.AWGFreq 3*pi/2 gSG.AWGAmp];
        C_2 = [C_2;...
