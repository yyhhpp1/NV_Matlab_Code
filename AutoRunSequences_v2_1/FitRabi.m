...
try
    ...
    if strcmp(model, 'cos_exp')
        fit_text = sprintf(['Pi Time = %.1f +/- %.1f ns\nPi/2 Time = %.1f +/- %.1f ns\n', ...
            'Freq = %.2f +/- %.2f MHz\nTau = %.1f ns\nPhase = %.2f +/- %.2f\nC = %.1f %%'], ...
            piTime, piTime_err, piHalfTime, piHalfTime_err, freq, freq_err, popt(4), phi, perr(3), contrast);
    else
        fit_text = sprintf(['Pi Time = %.1f +/- %.1f ns\nPi/2 Time = %.1f +/- %.1f ns\n', ...
            'Freq = %.2f +/- %.2f MHz\nPhase = %.2f +/- %.2f\nC = %.1f %%'], ...
            piTime, piTime_err, piHalfTime, piHalfTime_err, freq, freq_err, phi, perr(3), contrast);
    end
