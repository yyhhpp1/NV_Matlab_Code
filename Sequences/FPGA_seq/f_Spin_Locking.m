...
seq_len = round((gmSEQ.halfpi * 2 + gmSEQ.m + 4) * 2.6);
...
uploadSimplePulse('+Y_long', gSG.FPGAFreq7, gSG.FPGAGain5, max_pulse_length, 90)
uploadSimplePulse('+Y_short', gSG.FPGAFreq7, gSG.FPGAGain5, remain_pulse_length, 90)
